...
**Public Transport Complaint & Safety Platform**

🏆 **Award:** 2nd Runner-Up — UIU Database Management Course Competition  
Selected among **120+ teams** for system design, implementation, and UI quality

> A frontend-driven civic-tech platform focused on **complaint flows, dashboards, real-time updates, and user experience**, integrated with backend and AI services.

🔗 **Repository:**  
👉 <a href="https://github.com/rubayet36/Jatri-Ovijog">github.com/rubayet36/Jatri-Ovijog</a>

**What I Built (End-to-End):**
- Designed and built **user complaint flows & forms**
- Implemented **police & admin dashboards**
- Created **social feed UI** with reactions & comments
- Built **responsive layouts** for web & mobile
- Integrated frontend with **Spring Boot APIs & Supabase auth**
- Visualized AI analysis results in UI

**Tech you showcase here:**  
`HTML` · `CSS` · `JavaScript` · `UI Architecture` ·  
`State & Data Flow` · `API Integration`
...
<table>
  ...
  <tr>
    <td align="center" colspan="3"><img src="https://skillicons.dev/icons?i=prisma" width="45"><br>Prisma</td>
    <td align="center" colspan="3"><img src="https://skillicons.dev/icons?i=docker" width="45"><br>Docker</td>
  </tr>
  <tr>
    <td align="center" colspan="3"><img src="https://skillicons.dev/icons?i=nginx" width="45"><br>Nginx</td>
    <td align="center" colspan="3"><img src="https://skillicons.dev/icons?i=aws" width="45"><br>AWS</td>
  </tr>
</table>
...
<p align="center"><sub>Open to frontend roles, internships, and collaboration</sub></p>
